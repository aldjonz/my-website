...
// Create the base material class first
...
// Extend Three.js with our material
extend({ HologramShaderMaterial })

// Export the material class for direct instantiation
export class HolographicMaterialImpl extends HologramShaderMaterial {
  constructor() {
    super()
...
// Keep the existing React component
